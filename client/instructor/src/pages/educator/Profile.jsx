...
const Profile = () => {
  ...
  return (
    <div className="max-w-2xl m-6 bg-white border border-slate-200 rounded-xl p-6 space-y-5">
      ...
      <form onSubmit={onPasswordSubmit} className="space-y-5 pt-4 border-t border-slate-200">
