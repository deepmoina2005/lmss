			...
			<div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
				<div className="flex flex-col md:items-start items-center w-full">
					...
					<p className="mt- text-center sm:flex sm:flex-row sm:justify-center  md:text-left text-sm text-white/80">
						VidyaHub makes education accessible and engaging, connecting
					...
					<div className="flex items-center gap-3">
						<img className="w-12 h-12" src="/favicon.svg" alt="VidyaHub logo" />
						<span className="text-3xl font-bold text-white">VidyaHub</span>
					</div>
